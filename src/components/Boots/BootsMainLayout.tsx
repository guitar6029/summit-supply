    ...
    <>
      <section className="flex flex-col items-start gap-2 w-full md:w-fit mt-10">
        <Link
          ...
          className="w-full cursor-pointer flex flex-col rounded-xl gap-2 text-center p-4 text-5xl font-bold hiking-font hover:bg-black transition duration-300 ease-in"
        >
          <Image
